...
export const PlasmStrength: ICardItem[] = [
    ...
    },
    {
        ...
        heading: 'Substrate',
        content: 'Plasm Network is built with Substrate, a forkless scalable blockchain framework that uses WebAssembly'
    },
    {
        id: 5,
        icon: FilterTiltShiftOutlinedIcon,
        heading: 'Parachain',
        content: 'Plasm Network is a Parachain that provides interoperability with other blockchains who are either a Parachian themselves or via a Bridge'
    },
    {
        id: 6,
